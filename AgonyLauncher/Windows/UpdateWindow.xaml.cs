...
namespace AgonyLauncher.Windows
{
    ...
    public partial class UpdateWindow
    {
        ...
        private string StatusString
        {
            get
            {
                return string.Format("{2} (step {0} of {1}):  {3}", CurrentRoutineIndex + 1, Routines == null ? -1 : Routines.Length, Status, Details);
            }
        }
        ...
        private void Window_Closing(object sender, CancelEventArgs e)
        {
            ...
            if (!AllowExit)
            {
                var result =
                    MessageBox.Show(
                        "Agony update wizard is currently busy. It is recommended that you wait to finish. Do you really want to exit?",
                        "Agony Update Wizard", MessageBoxButton.YesNo, MessageBoxImage.Exclamation);
